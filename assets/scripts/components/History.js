cc.Class({
    ...
    onLoad: function () {
        ...
        // this._btnBack = this._history.getChildByName("btn_back");
        ...
        var node = cc.find("Canvas/history/help_p_bg/btn_back");  
    ...
    onBtnBackClicked:function(){
        if(this._curRoomInfo == null){
            ...
            var animCtrl = this._history.getComponent(cc.Animation);
