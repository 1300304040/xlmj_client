cc.Class({
    ...
    onLoad: function () {
        ...
        if(btnVoice){
            btnVoice.on(cc.Node.EventType.TOUCH_START,function(){
                ...
                var animCtrl = self._voice.getComponent(cc.Animation);
            ...
            btnVoice.on(cc.Node.EventType.TOUCH_END,function(){
                ...
                if(Date.now() - self._lastTouchTime < 1000){
                    ...
                    var animCtrl = self._voice_failed.getComponent(cc.Animation);
                        animCtrl.play("showAlert");
    ...
    onVoiceOK:function(){
        ...
        // this._voice.active = false;
        var animCtrl = this._voice.getComponent(cc.Animation);
